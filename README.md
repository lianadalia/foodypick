...
AI-assisted functional UI prototype for a fictional food delivery app, built as a UX research artefact for discussion with product and engineering teams . Covers the full order journey from splash screen to live order tracking across 10 screens.
